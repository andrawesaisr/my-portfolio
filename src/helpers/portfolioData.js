import chatApp from "../images/projects/chat-app.gif";
import memeGenerator from "../images/projects/meme-generator.gif";
import quizApp from "../images/projects/quiz-app.gif";
...
const portfolioData = [
  {
    ...
    desc: "chat app",
    summary:
      "creat room and give the name of it to your friends and start chating with them",
    tech: "socket.io | node.js | html | css",
  },
  {
    image: socialMedia,
    link: "https://github.com/andrawesaisr/social_media",
    desc: "social media",
    summary:
      "A social media platform to create posts, like, and follow other users with authentication and profile management.",
